...
def get_symbols(symbol_set):
    ...
    elif symbol_set == 'polish':
        _punctuation = '!\'",.:;? '
        _math = '#%&*+-/[]()'
        _special = '_@©°½—₩€$'
        _numbers = '0123456789'
        _letters = 'AĄBCĆDEĘFGHIJKLŁMNŃOÓPQRSŚTUVWXYZŻŹaąbcćdeęfghijklłmnńoópqrsśtuvwxyzżź'
        _arpabet = ["@" + s for s in arpabet]
        symbols = list(_punctuation + _math + _special + _numbers + _letters) + _arpabet        
    else:
